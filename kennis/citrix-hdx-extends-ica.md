...
status: actief
datum: 2026-06-09
tags: [hdx, ica, user-experience, h264, gpu]
layer: reference
bron: inside-citrix-fma
---

# Citrix HDX: an extension to ICA, not a replacement

HDX (High Definition Experience) is more than 'just' the ICA protocol and is often misunderstood. HDX technologies are built **on top of** the ICA protocol and extend it: they are not a replacement.
