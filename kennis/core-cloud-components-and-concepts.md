...
status: actief
datum: 2026-06-09
tags: [cloud-components, virtualization, api, storage, elasticity]
layer: reference
bron: van-de-basis-tot-meester-in-de-cloud
---

# Core cloud building blocks: datacenter, virtualization, APIs, storage, databases, elasticity

Bas's overview of foundational cloud components:
- Servers/networks need a home: all components together, including power, cooling, racks etc., make up the datacenter.
- Systems are virtualized: it would be impossible to reach the same economies of scale on physical servers.
- APIs for access to services: virtually all systems, services and other cloud solutions are driven via an API, nowadays wrapped in various graphical interfaces.
