...
# Common Cloud Concerns: Cost, Migration, Loss of Control

Bas links the 'Zorgen' (concerns) section back to Opdracht 1 from Chapter 1, so readers can compare their own objections against the most common ones. He is explicit that the book is NOT meant to convince you the cloud is right or that your concerns are unfounded — his goal is to show the possibilities, discuss pros and cons, and give you the tools to prepare, execute, guide, and finish a migration successfully.
