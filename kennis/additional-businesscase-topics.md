...
status: actief
datum: 2026-06-09
tags: [business-case, change-management, kpi, sustainability, stakeholders]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# Additional Topics to Weigh in a Cloud Business Case

Beyond hard costs, Bas lists supplementary topics to consider (depending on your goal) when building a cloud business case:

- **Change management:** how the organisation handles changes flowing from the business case — training needs and cultural change.
- **How do you measure success?** Which KPIs to track (see Chapter 14).
- **Stakeholder analysis:** who is involved and what are their interests — helps identify resistance or support.
- **Competitor analysis:** depending on the sector, can reveal how the case provides competitive advantage.
