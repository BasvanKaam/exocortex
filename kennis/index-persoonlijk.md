...
Wie Bas is buiten de techniek: zijn drijfveren, leerritueel, schrijf- en blogfilosofie, loopbaankeuzes, en de posities die zijn waarden tonen.

## Blogging & kennisdeling
De motor onder zijn carriere: delen als doel op zich.
...
- [Bas's practical blogging playbook (process and craft rules)](bas-practical-blogging-playbook.md)
...
- [The -1000 series: shorter posts to ship more often](minus-1000-series-short-form-rationale.md)

## Content-strategie & editorial
Wanneer en waarom hij publiceert.
...
## Schrijven & self-publishing
Het FMA-boek en wat een tech-boek echt kost.
- [Writing the FMA book was brutal but never regretted](self-publishing-fma-book-worth-it.md)
- [What writing a tech book actually costs in time](writing-a-tech-book-time-investment.md)
...
- [Kindle e-books are reflowable and effectively HTML/CSS under the hood](kindle-formatting-is-html-css.md)
- [On outsourcing creative work cheaply: you get what you pay for](you-get-what-you-pay-for-fiverr.md)

## Leren, lezen & note-taking
Het dagelijkse leerritueel en zijn methodes.
...
- [Bas reads to learn, not to escape](reads-to-learn-not-fiction.md)
...
- [Handwriting aids retention and idea flow (the RAS filter)](handwriting-aids-retention-ras.md)
...
- [Be yourself, don't copy others, and just ship the idea](position-be-yourself-dont-copy.md)
...
## Sysadmin 2.0 & het IT-vak
Zijn visie op hoe de beheerdersrol moet veranderen.
...
## Salomon-era: team, cultuur & propositie
Posities uit de Salomon-periode over partnership, cultuur en uitvoering.
...
## Werkplek, gezondheid & hobby
Het persoonlijke leven naast het werk.
...
## Posities
De kernstandpunten die zijn waarden tonen.
- [Community involvement as the engine of his career](positie-community-as-career-engine.md)
- [Stance: freely sharing knowledge is the best advertising a company can get](free-knowledge-sharing-is-the-best-advertising.md)
- [The blog began as a personal knowledge base, and sharing became the point](blog-as-personal-knowledge-base-origin.md)
- [Treating the job as a hobby you'd do anyway](work-as-hobby-philosophy.md)
