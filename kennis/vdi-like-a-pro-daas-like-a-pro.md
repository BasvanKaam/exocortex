...
status: actief
datum: 2026-06-09
tags: [vdi-like-a-pro, euc, vdi, daas, research, state-of-euc]
layer: reference
bron: van-de-basis-tot-meester-in-de-cloud
---

# VDI Like a Pro / DaaS Like a Pro research initiative

VDI Like a Pro is an independent research initiative focused on End User Computing (EUC), with special emphasis on Virtual Desktop Infrastructure (VDI), Desktop as a Service (DaaS) and Cloud PC solutions. It was founded by Ruben Spruijt, Christiaan Brinkhoff and Mark Plettenberg - three experts with a shared passion for collecting and sharing EUC-community knowledge.
