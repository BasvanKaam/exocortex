...
status: actief
datum: 2026-06-09
tags: [delivery-models, iaas, paas, saas, daas]
layer: reference
bron: van-de-basis-tot-meester-in-de-cloud
---

# Cloud delivery models: IaaS, PaaS, SaaS and DaaS

The Cloud offers many (thousands of) services across delivery models, each aimed at a different level of management and control. The four most common and best-known models:

- Infrastructure as a Service (IaaS): the most fundamental model - access to virtual infrastructure like servers, storage and networks. The organisation manages the applications and operating systems on top, but not the physical infrastructure. Examples: AWS EC2, Azure Virtual Machines. Used for flexible compute power without investing in physical systems.
- Platform as a Service (PaaS): a platform for developers to build and run applications without worrying about the underlying infrastructure. Examples: Google App Engine, Microsoft Azure App Services. Ideal for quickly developing and testing applications.
- Software as a Service (SaaS): software delivered and maintained directly via the Cloud by a third party, eliminating local installation and management (local install is often still possible depending on the licence). Examples: Microsoft 365 (formerly Office), Salesforce, Google Workspace. Popular for ease of implementation and scalability.
