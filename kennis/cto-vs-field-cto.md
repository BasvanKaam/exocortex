...
status: actief
datum: 2026-06-09
tags: [cto, field-cto, roles, sales, customer]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# CTO vs Field CTO: internal strategy vs external customer translation

Bas distinguishes two technology-leadership roles. A regular **CTO** has an internal focus: setting the technological course, managing innovation programmes (Office of the CTO, Innovation Board), safeguarding security and efficiency of internal systems, and developing/implementing a vision that moves the organisation forward, working with other leaders.
