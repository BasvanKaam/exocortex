...
status: actief
datum: 2026-06-09
tags: [capex, opex, pros-cons, cloud-economics]
layer: reference
bron: van-de-basis-tot-meester-in-de-cloud
---

# Capex and Opex - Pros and Cons

**Capex pros:** long-term value (servers/datacenters last years and stay on the balance sheet as assets); full control over infrastructure; depreciation over multiple years yields tax benefits.
**Capex cons:** high initial costs (hard for limited cashflow); risk of obsolescence (tech ages fast, forcing upgrades); maintenance costs (the company is responsible itself).
