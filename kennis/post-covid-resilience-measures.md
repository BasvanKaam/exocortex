...
status: actief
datum: 2026-06-09
tags: [business-continuity, bcp, supply-chain, automation, resilience]
layer: reference
bron: van-de-basis-tot-meester-in-de-cloud
---

# Post-COVID resilience: BCPs, redundancy, supply chains, automation

After COVID, organisations focused on being better prepared for a future event of similar scale, taking concrete steps:
- Renewed and expanded Business Continuity Plans (BCPs) with draaiboeken (playbooks): concrete steps and protocols to switch quickly to remote-work models, regularly tested and updated so staff are familiar with procedures and the plan is continuously optimised.
- More investment in redundant systems and processes that act as backups, keeping critical processes running when parts of the infrastructure fail unexpectedly.
