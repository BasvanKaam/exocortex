...
status: actief
datum: 2026-06-09
tags: [scaf, rationalisation, refactor, iaas, paas, saas, daas]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# Definitive Cloud and Refactor Choice (Rationalisation)

In the Execution phase Bas determines not only whether a component (application, system, dataset, network part) should be modernised, but also whether and how it goes to the Cloud, choosing among IaaS, PaaS, SaaS or DaaS (Desktop as a Service). The same inventory forms used earlier in the process are reused.

In most cases the choice about whether to move to the Cloud (and in what form) stays the same as decided in the Insight phase. If a component cannot move (technical limitations or company rules), the decision is substantiated and an alternative proposed.
