...
status: actief
datum: 2026-06-09
tags: [scaf, execution, framework, migration, waves]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# SCAF Execution Phase (Uitvoeringsfase) Overview

Chapter 11 of Bas's Step-Cloud Adoptie Framework covers the Execution phase (Uitvoering), where you move to action, but not by randomly clicking things together. Much of what was discussed and done during the Insight (inzicht) phase now takes definitive, formalised shape. Opening epigraph: "The way to get started is to quit talking and begin doing." — Walt Disney.

Key points:
- It picks up 'unfinished business' from the waves: specifically wave 3 (waves 1 and 2 were done in the Insight phase). Wave 3 covers detailed per-application/data/system rationalisation and the modernisation decisions.
