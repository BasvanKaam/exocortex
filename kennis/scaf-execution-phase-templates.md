...
status: actief
datum: 2026-06-09
tags: [scaf, execution, migration, pdca, agile, framework]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# SCAF execution-phase templates and the migration waves

The execution (uitvoering) phase of Bas's Step-Cloud Adoptie Framework (SCAF) is supported by:

- **Execution Management Summary Palet**: summarises progress and results of the execution phase. It covers the third migration wave (focused on modernisation) and the definitive security solutions, introduces the Plan-Do-Check-Act (PDCA) cycle and agile working methods, documents the chosen cloud platform with justification and any cloud-exit strategy, and tracks the skill-readiness plan and updated governance model, plus the final tooling and migration plan for the first workloads.
