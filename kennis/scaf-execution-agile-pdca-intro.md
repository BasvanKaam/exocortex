...
status: actief
datum: 2026-06-09
tags: [scaf, agile, pdca, governance, iac]
layer: rich
bron: van-de-basis-tot-meester-in-de-cloud
---

# Introducing Agile and Plan-Do-Check-Act in Execution

As part of the Execution phase results, Bas starts introducing agile working, with the Plan-Do-Check-Act (PDCA) cycle explained more fully in the Adoption phase. Governance policies and rules are revised periodically under PDCA so they stay current and aligned to changing Cloud needs and technologies, and earlier choices can be reconsidered later (the agile mindset).
