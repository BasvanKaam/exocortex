...
status: actief
datum: 2026-06-09
tags: [opex-capex, cloud-economics, pay-as-you-go, depreciation]
layer: reference
...
Two key factors in financial decisions. **Capex** (capital expenditure) refers to large one-off outlays that deliver long-term value — buildings, vehicles, machines, and in IT terms datacenters and network infrastructure. These investments are often depreciated over several years, letting companies recoup part of the cost via tax benefits each year. Capex assets sit on the balance sheet and add to company value (e.g. matters hugely at the scale of Facebook or Twitter/X).
